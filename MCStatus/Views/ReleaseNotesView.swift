...
struct ReleaseNotesView: View {
    ...
    let features = [
        ...
        Feature(title: "Apple Watch App", description: "Get MC Status on your wrist with the new Apple Watch app and a full suite of complications.", icon: "applewatch.watchface", iconColor: .gray),
