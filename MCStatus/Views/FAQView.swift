...
func getiOSFAQs() -> [FAQ] {
    ...
    return [
        ...
        FAQ(question: "Why are some servers missing player lists?", answer: "Some servers have plugins to disable this feature or return custom messages and other content in place of player names. Additionally, bedrock servers do not support player lists."),
